...
public class PublicationController : ControllerBase
{
    ...
    {
        this._mapper = mapper;
        this._publicationDomain = publicationDomain;
    }
    ...
    /// </summary>
    /// <param name="publicationGetRequest">Query request parameter that represents what publication to retrieve.</param>
    /// <returns>
    ...
    public async Task<IActionResult> GetPublication([FromQuery] GetPublicationRequest publicationGetRequest)
    {
        ...
        var getPublicationModel = this._mapper.Map<GetPublicationModel>(publicationGetRequest);
        var result = await this._publicationDomain.GetPublicationAsync(getPublicationModel);
    ...
    /// </summary>
    /// <param name="publicationPostRequest">Body request parameters that represents a publication instance.</param>
    /// <returns>
    ...
    public async Task<IActionResult> PostPublication([FromBody] PostPublicationRequest publicationPostRequest)
    {
        if (!ModelState.IsValid)
        {
            return BadRequest(ModelState);
        ...
        var publicationModel = this._mapper.Map<PublicationModel>(publicationPostRequest);
        var result = await this._publicationDomain.PostPublicationAsync(publicationModel);
    ...
    public async Task<IActionResult> DeletePublication([FromBody] int id)
    {
        ...
        var result = await this._publicationDomain.DeletePublicationAsync(id);
